...
for (let i = 0; i < numberOf_keys; i++) {
  ...
  let nativeUnicodeEmoji = unicodeCodePointOrPairToChar(unicode) // TODO/FIXME: move call to emojione.unicodeCodePointOrPairToChar()
...
const obj = { Emojis, EmojiCategories }
export default obj
