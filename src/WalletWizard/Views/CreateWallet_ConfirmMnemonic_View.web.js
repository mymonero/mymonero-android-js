...
class CreateWallet_ConfirmMnemonic_View extends BaseView_AWalletWizardScreen {
  ...
  _setup_actionButton_tryAgain () {
    ...
    const buttonView = commonComponents_actionButtons.New_ActionButtonView(
      'Try again',
      './src/assets/img/actionButton_iconImage__tryAgain@3x.png', // relative to index.html
      false,
      function (layer, e) {
  ...
  _setup_actionButton_startOver () {
    ...
    const buttonView = commonComponents_actionButtons.New_ActionButtonView(
      'Start Over',
      './src/assets/img/actionButton_iconImage__startOver@3x.png', // relative to index.html
      true,
      function (layer, e) {
