...
const rounded_ccyConversionRateCalculated_moneroAmountNumber = function (
  CcyConversionRates_Controller_shared,
...
export default {
  ...
  rounded_ccyConversionRateCalculated_moneroAmountNumber,
  nonAtomicCurrency_formattedString,
  submittableMoneroAmountDouble_orNull,
  unitsForDisplay,
  hasAtomicUnits
}
